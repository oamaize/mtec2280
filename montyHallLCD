...
//doorWithPrize = 2;
  Serial.println("prize door: ");
  Serial.println(doorWithPrize);
  //buttonState2 = 0; // current state of the button
  //lastButtonState2 = 0; // previous state of the button
  //buttonPushCounter3 = 0; // counter for the number of button presses
  //buttonState3 = 0; // current state of the button
  //lastButtonState3 = 0; // previous state of the button
}
}
lastButtonState3 = buttonState3;
}
